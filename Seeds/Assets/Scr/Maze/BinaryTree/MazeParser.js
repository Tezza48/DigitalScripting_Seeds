...
public class MazeParser extends MonoBehaviour{
      ...
      public function ParseMaze(cells : Cell[,], tiles : Tiles, mazeWidth : int, mazeHeight : int, tileSize : int) {
            ...
            mazeHolder = Instantiate(GameObject("Maze Holder"), new Vector2(0, 0), Quaternion.identity);
            ...
            for (var y = 0; y < mazeHeight; y++) {
                  for (var x = 0; x < mazeWidth; x++) {
                        ...
                        mazeTile = Instantiate(maze[x, y].GetTile(), Vector2(x * tileSize, y * tileSize), Quaternion.identity);
                        mazeTile.name = "Tile (" + x + ", " + y + ")";
                        mazeTile.transform.parent = mazeHolder.transform;
                  }
            }
      }
}
